...
export class ServiceAccountsClient {
   ...
   */
  public async list(selector?: ServiceAccountsSelector, opts?: meta.ListOptions): Promise<meta.List<ServiceAccount>> { // eslint-disable-line @typescript-eslint/no-unused-vars
    const req = new rm.Request("GET", "v2/service-accounts")
    req.listOpts = opts
    return this.rmClient.executeRequest(req) as Promise<meta.List<ServiceAccount>>
  }
